...
public class CustomerHistoryModel {
    ...
    public CustomerHistoryModel(String id, String productID, String productSellerID, String productName, String product_Desc, String product_category, String price_each, String quantity, String subtotal) {
        this.id = id;
