...
public class DriverProductModel {

    private String id,productID,productName,price_each,product_Desc,product_category,quantity,subtotal;

    public  DriverProductModel(){

    }

    public DriverProductModel(String id, String productID, String productName, String price_each, String product_Desc, String product_category, String quantity, String subtotal) {
        this.id = id;
