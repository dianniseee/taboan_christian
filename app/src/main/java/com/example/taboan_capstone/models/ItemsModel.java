...
public class ItemsModel {
    ...
    public ItemsModel(String id, String productID, String productName, String price_each, String product_Desc, String product_category, String quantity, String subtotal) {
        this.id = id;
